...
const followUnfollow = async (
    dispatch: Dispatch,
    userId: string,
    apiMethod: (id: string) => any,
    actionCreator: (id: string) => any
) => {
...
export const follow = (userId: string) => {
    return async (dispatch: Dispatch) => {
        followUnfollow(dispatch, userId, UsersAPI.follow.bind(userId), AcceptFollow);
    };
};

export const unFollow = (userId: string) => {
    return async (dispatch: Dispatch) => {
        followUnfollow(dispatch, userId, UsersAPI.unFollow.bind(userId), AcceptUnFollow);
    };
};
